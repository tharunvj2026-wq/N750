...
VOLUME_SURGE_MIN = 1.40       # 1.4x 
VOLUME_LOOKBACK_DAYS = 7 
VOLUME_PREV_SETS = 4 
TOP_STOCKS = 5 

# ============================================ 
# NIFTY 750 SYMBOLS (full list – keep yours) 
# ============================================ 
NIFTY_SYMBOLS = [ 
...
# ============================================ 
# GET LAST 35 TRADING DATES (INCLUDES TODAY) - FIXED 
# ============================================ 
...
# ============================================ 
# FETCH BHAVCOPY WITH FALLBACK - FIXED 
# ============================================ 
...
def build_database(): 
    ...
    print(f" Period: Last 35 trading days (including today if trading day)") 
...
def main(): 
    try: 
        ...
        import traceback 
        traceback.print_exc() 
        # Exit with 0 to avoid false failure in automation if you prefer 
        # sys.exit(1)  # uncomment if you want non-zero exit on error 
